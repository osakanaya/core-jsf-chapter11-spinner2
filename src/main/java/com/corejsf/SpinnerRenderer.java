...
@FacesRenderer(componentFamily = "javax.faces.Input", rendererType = "com.corejsf.Spinner")
public class SpinnerRenderer extends Renderer {
	...
	private void encodeDecrementButton(UIComponent spinner, ResponseWriter writer, String clientId) throws IOException {
	...
	private void encodeIncrementButton(UIComponent spinner, ResponseWriter writer, String clientId) throws IOException {
		writer.startElement("input", spinner);
	...
	private int getIncrementedValue(UIComponent spinner, int submittedValue, int increment) {
		...
		MethodExpression minMethod = (MethodExpression)spinner.getAttributes().get("atMin");
		...
		MethodExpression maxMethod = (MethodExpression)spinner.getAttributes().get("atMax");
